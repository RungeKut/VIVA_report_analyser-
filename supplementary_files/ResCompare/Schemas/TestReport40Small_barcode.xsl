                          ...
                          <xsl:if test="@FR != ''">
                            <TR>
                              <TD>
                                <PRE>
                                  <xsl:text>&#160;&#160;</xsl:text>
                                  <!-- Invertire l'abilitazione delle due linee seguenti per abilitare la gestione colori o altro da utente -->
